...
export class Backend implements backendInterface {
    ...
    async getPlayersCar(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayersCar(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getTopScores(arg0: bigint): Promise<Array<PlayerScore>> {
        if (this.processError) {
            try {
    ...
    async submitScore(arg0: string, arg1: number, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
